    ...
    return (
        ...
        <section>
            ...
            <div className="border border-[#ccc] py-2 px-3 mb-2 rounded-md sm:flex justify-between  items-center sm:text-sm text-xs ">
                ...
                <Link href="/exames/download" style={{textDecoration: "none"}} className=" text-[#2c8385] font-semibold tracking-normal rounded-sm flex mt-0.5 sm:sm:text-sm text-xs">baixar<LiaFileDownloadSolid className="text-xs sm:text-lg"/></Link>
            </div>
            <div className="border border-[#ccc] py-2 px-3 mb-2 rounded-md sm:flex justify-between  items-center sm:text-sm text-xs ">
                <p className="m-0">baixar exame de Portugues-II / 2021 </p>
                <Link href="/exames/download" style={{textDecoration: "none"}} className=" text-[#2c8385] font-semibold tracking-normal rounded-sm flex mt-0.5 sm:sm:text-sm text-xs">baixar<LiaFileDownloadSolid className="text-xs sm:text-lg"/></Link>

...
export default function ExameMatematicaUP(){
    return (
        ...
        <section>
            <h6 className="font-light text-center sm:text-sm text-xs">baixe todos  <span className="font-medium">exames de matematica da UP</span>  desde o ano 2009 ate 2023</h6>
